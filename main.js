...
const categoryAngles = {
  Music: { start: 0, end: 90 }, // 0 to 90 degrees for Movies
  Celebrity: { start: 90, end: 180 }, // 90 to 180 degrees for Television
  Television: { start: 180, end: 270 }, // 180 to 270 degrees for Celebrities
  Movie: { start: 270, end: 360 }, // 270 to 360 degrees for Music
};
spinButton.onclick = function () {
  // Generate a random angle to spin the wheel
  const randomAngle = Math.ceil(Math.random() * 3600);

  // Calculate the final angle for the wheel
  const finalAngle = randomAngle + 360 * 10; // Add extra rotations for effect

  // Set a faster transition duration (e.g., 5 seconds)
  wheel.style.transition = "transform 5s ease-in-out"; // Faster spin

  // Apply the rotation
  wheel.style.transform = `rotate(${finalAngle}deg)`;

  // After the wheel stops spinning, calculate the selected category
  setTimeout(() => {
    selectedCategory = calculateSelectedCategory(finalAngle);
    ...
    //document.querySelector('.container').style.animation-delay = '5s';
    document.querySelector(".container").style.animation =
      "fadeOut 3s ease-in forwards";
    setTimeout(() => {
      // Hide the spinning wheel container
      let spinningWheel = document.querySelector(".Spinwheel");
      spinningWheel.innerHTML = "";

      // Show the Trivia game container
      const triviaGame = document.querySelector(".Triviagame");
...
function calculateSelectedCategory(rotationAngle) {
  // Calculate the normalized angle within 360 degrees
  const normalizedAngle = ((rotationAngle % 360) + 360) % 360;

  // Determine the selected category based on the angle range
  let selectedCategory = "";
  for (const category in categoryAngles) {
    const { start, end } = categoryAngles[category];
    if (normalizedAngle >= start && normalizedAngle < end) {
      selectedCategory = category;
      break;
    }
  }
  // Update the selected category in the message
  selectedCategorySpan.textContent = selectedCategory;
...
const questions = [
  ...
  {
    question:
      "Which legendary music group performed at the famous Woodstock Festival in 1969?",
    answers: [
  ...
  {
    question:
      "Which singer is known for hits like 'Hello' and 'Someone Like You'?",
    answers: [
  ...
  {
    question:
      "What is the stage name of the rapper and actor born as Marshall Mathers?",
    answers: [
  ...
  {
    question:
      "What song did Queen perform during their iconic Live Aid performance in 1985?",
    answers: [
  ...
  {
    question:
      "Which rock band's album 'OK Computer' is often considered one of the greatest albums of all time?",
    answers: [
  ...
  {
    question:
      "What is the name of the lead guitarist of the band Led Zeppelin?",
    answers: [
  ...
  {
    question:
      "Which 1967 album by The Beatles features songs like 'Lucy in the Sky with Diamonds' and 'A Day in the Life'?",
    answers: [
  ...
  {
    question:
      "Which comedian is known for hosting 'The Tonight Show' and 'The Jay Leno Show'?",
    answers: [
  ...
  {
    question:
      "Who is the lead actor in the 'Pirates of the Caribbean' film series?",
    answers: [
  ...
  {
    question:
      "Who is the actress known for her role as Hermione Granger in the 'Harry Potter' film series?",
    answers: [
  ...
  {
    question:
      "Which actor is famous for portraying Jack Dawson in the film 'Titanic'?",
    answers: [
  ...
  {
    question:
      "Who won the Academy Award for Best Actor for his role in the film 'Forrest Gump'?",
    answers: [
  ...
  {
    question:
      "Which actress starred as Black Widow in the Marvel Cinematic Universe?",
    answers: [
  ...
  {
    question:
      "Who is the actor known for his portrayal of James Bond in several films?",
    answers: [
  ...
  {
    question:
      "Which actor starred as Walter White in the TV series 'Breaking Bad'?",
    answers: [
  ...
  {
    question:
      "Who is the actress known for her role as Eleven in the TV series 'Stranger Things'?",
    answers: [
  ...
  {
    question:
      "Which actor portrayed Hannibal Lecter in the film 'The Silence of the Lambs'?",
    answers: [
      { text: "Robert De Niro", correct: false },
  ...
  {
    question:
      "Who is the actor famous for his role as Tony Stark in the Marvel Cinematic Universe?",
    answers: [
      { text: "Chris Hemsworth", correct: false },
  ...
  {
    question:
      "Which actress won an Academy Award for her performance in the film 'La La Land'?",
    answers: [
      { text: "Natalie Portman", correct: false },
  ...
  {
    question:
      "Which film features a young lion named Simba who embarks on a journey to reclaim his throne?",
    answers: [
  ...
  {
    question:
      "Who played the role of Tony Stark in the 'Iron Man' film series?",
    answers: [
      { text: "Chris Evans", correct: false },
      { text: "Chris Hemsworth", correct: false },
      { text: "Robert Downey Jr.", correct: true },
  ...
  {
    question:
      "Which animated film follows the adventures of a young clownfish named Nemo?",
    answers: [
  ...
  {
    question:
      "In 'Jurassic Park,' what type of creatures do the characters encounter?",
    answers: [
  ...
  {
    question:
      "Which film tells the story of a young wizard named Harry Potter?",
    answers: [
  ...
  {
    question:
      "Which film follows the story of an elderly man named Carl Fredricksen and a young Wilderness Explorer named Russell?",
    answers: [
  ...
  {
    question:
      "In the film 'The Shawshank Redemption,' what does Andy Dufresne use to escape from prison?",
    answers: [
  ...
  {
    question:
      "Which film is often considered the first feature-length animated movie?",
    answers: [
      { text: "The Little Mermaid", correct: false },
  ...
  {
    question:
      "Which actor portrayed the character Jack Dawson in the film 'Titanic'?",
    answers: [
      { text: "Leonardo DiCaprio", correct: true },
      { text: "Matt Damon", correct: false },
      { text: "Brad Pitt", correct: false },
  ...
  {
    question:
      "Which TV show features a group of friends living in New York City and includes characters like Ross, Rachel, and Joey?",
    answers: [
  ...
  {
    question:
      "Which TV show is about a high school chemistry teacher who turns to cooking and selling methamphetamine after a terminal cancer diagnosis?",
    answers: [
  ...
  {
    question:
      "Which TV show is set in the fictional town of Pawnee, Indiana, and follows the quirky employees of the Parks and Recreation department?",
    answers: [
      { text: "The Office", correct: false },
  ...
  {
    question:
      "Which TV show follows the lives of four women in New York City named Carrie, Charlotte, Miranda, and Samantha?",
    answers: [
  ...
  {
    question:
      "In 'The Walking Dead,' what do the survivors call the undead creatures?",
    answers: [
      { text: "Zombies", correct: false },
  ...
  {
    question:
      "Which TV show is a mockumentary-style series that follows the lives of employees at the Dunder Mifflin Paper Company?",
    answers: [
      { text: "Brooklyn Nine-Nine", correct: false },
  ...
  {
    question:
      "What TV show features a brilliant but socially awkward forensic scientist named Dr. Temperance Brennan?",
    answers: [
  ...
  {
    question:
      "In 'Breaking Bad,' what is the street name of the high-quality blue methamphetamine produced by Walter White?",
    answers: [
  ...
  {
    question:
      "Which TV show is known for its complex characters like Tony Soprano, a mob boss dealing with personal and professional issues?",
    answers: [
  ...
  {
    question:
      "Which TV show features a high school chemistry teacher who becomes a notorious methamphetamine manufacturer and drug lord?",
    answers: [
      { text: "Breaking Bad", correct: true },
...
//Bring back spinningwheel
function generateSpinningWheelHTML() {
  return `
        <div class="container">
            <h1> Welcome to Pop Culture Trivia!</h1>
            <h2>Hosted by Aaron Simmons</h2>
            <div class="spinButton">Spin</div>
            <div class="wheel">
                <div class="selection" style="--i:1;--clr:#db7093;"><span>Movies</span></div>
                <div class="selection" style="--i:2;--clr:#0fba31;"><span>Television</span></div>
                <div class="selection" style="--i:3;--clr:#310af4;"><span>Celebrities</span></div>
                <div class="selection" style="--i:4;--clr:#f2850982;"><span>Music</span></div>
            </div>
            <div class="pointer"></div>
            <div class="message">
                Congratulations, you have selected the <span id="selectedCategory"></span> game. Let's Play!
            </div>
        </div>
    `;
}

function replaceSpinningWheelContent() {
  const spinningWheel = document.querySelector(".Spinwheel"); // Get the spinning wheel container
  const spinningWheelHTML = generateSpinningWheelHTML(); // Generate the HTML content
  spinningWheel.innerHTML = spinningWheelHTML; // Replace the content in the spinning wheel container
}
